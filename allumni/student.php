...
<html lang = "eng">
	<head>
		<title>Student Allumni School Records</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: green; color: white;">
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right" style="color: white;">Student Allumni School Records</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "modal fade" id = "add_student" tabindex = "-1" Section = "dialog" aria-labelledby = "myModallabel">
				<div class = "modal-dialog" Section = "document">
					<div class = "modal-content panel-primary">
						<div class = "modal-header panel-heading">
							<button type = "button" class = "close" data-dismiss = "modal" aria-label = "Close"><span aria-hidden = "true">&times;</span></button>
							<h4 class = "modal-title" id = "myModallabel">Add new Students</h4>
						</div>
			...
			<div class = "modal fade" id = "delete" tabindex = "-1" Section = "dialog" aria-labelledby = "myModallabel">
				<div class = "modal-dialog" Section = "document">
			...
			<div class = "modal fade" id = "edit_student" tabindex = "-1" Section = "dialog" aria-labelledby = "myModallabel">
				<div class = "modal-dialog" Section = "document">
		...
		<div class = "navbar navbar-fixed-bottom" style="background-color: blue; color: white;">
			<div class = "container-fluid">
				<center><label>&copy; Student Allumni School Records</label></center>
