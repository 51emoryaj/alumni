...
<html lang = "eng">
	<head>
		<title>BASC Allumni Information Management System</title>
		<meta charset = "utf-8" />
	...
	<body>
		<nav class = "navbar navbar-inverse navbar-fixed-top" style="background-color: green; color: white;" >
			<div class = "container-fluid">
				<div class = "navbar-header">
					...
					<p class = "navbar-text pull-right" style="color: white;">BASC Allumni Information Management System</p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			...
			<div class = "well col-lg-12">
				<img src = "images/basc.jpg"  width = "1300px" height = "500px" />
			<br />
			<br />	
			<br />	
			</div>
		...
		<div class = "navbar navbar-fixed-bottom" style="background-color: blue; color: white;">
			<div class = "container-fluid">
				<center><label>&copy; BASC Allumni Information Management System</label></center>
